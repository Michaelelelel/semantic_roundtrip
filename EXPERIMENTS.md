...
| Exploratory follow-up | `aqueduct_v4_384k_{d32,o120,v4}.yaml` | V4 TG at 384,000 output tokens on the same 12 description conditions | completed source descriptions and checks; one API key per runner; no local GPU |
